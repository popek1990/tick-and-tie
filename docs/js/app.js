...
console.info(
  [
    ...
    "",
    "The red POST failures are deliberate, and they are the measurement: while any observer mark is a day or more",
    "behind, this page asks each node the whole-cycle question the registry observer asked before it paged — one",
    "eth_getLogs over 10,000 blocks — then the 1,000-block page it asks now, to show what each one answers. Today",
    "(#/) prints every answer. Every other request here is capped at 2,000 blocks.",
    "",
    "In devtools:",
